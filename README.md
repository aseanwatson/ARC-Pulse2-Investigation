...
SPI traffic between the 6640 and the STM32L051 chip. See [PulseView file](data/SPI%20Boot%20Capture.sr). This
is decoded [here](Boot_SPI_Trace.md).

I was also able to capture the SPI traffic from pushing the "pair" button (twice). See [PulseView file](data/SpiPairButtonTwice.srzip).
This is decoded [here](MOSI_pair_twice_decoded.md).
